    ...
    <>
      ...
      <div className='w-4/5 m-auto'>
        <div className='mt-28 flex'>
          <div className='w-1/2'>
            <Image src="/main1.jpg" width={540} height={360} alt="メイン画像1" />
          </div>
        ...
        <div className='mt-28 flex'>
          ...
          <div className='w-1/2'>
            <Image src="/main2.jpg" width={540} height={360} alt="メイン画像1" />
          </div>
        </div>
        <div className='mt-28 flex'>
          <div className='w-1/2'>
            <Image src="/main3.jpg" width={540} height={360} alt="メイン画像1" />
          </div>
          <div className='pl-20 pt-20 w-1/2'>
            <h2 className='text-3xl my-1 mb-5'>安全にも配慮</h2>
            <p className='text-lg font-thin'>日々の整理整頓だけでなく、地震時にPCが倒れてこないようにするなどの安全対策も5S活動の一環として行うこともあります。</p>
          </div>
        </div>
      </div>
    </>
