  ...
  return (
    <div className='flex mt-40 mx-auto justify-center'>
      ...
      <div className='pl-32 pt-10'>
        ...
        <Link href="/">
          <a className="bg-slate-400 relative text-white my-6 block w-40 h-10 text-center leading-10 after:Font Awesome 5 Free after:duration-300 hover:after:bg-slate-400 hover:after:content-['➡'] after:absolute hover:after:translate-x-24 after:top-0 after:left-12 after:w-10 shadow-md">今までの活動</a>
        </Link>
      </div>
    </div>
  )
